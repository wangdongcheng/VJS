SELECT
    ...
    CU_VAT_REG_NO AS 'Tax Registration ID',
    CASE
    ...
    AC2.CU_USRCHAR10 AS 'Director 1',
    AC2.CU_USRCHAR12 AS 'Director 2',
    AC2.CU_USRCHAR13 AS 'Phone Marketing',
    ...
    AC2.CU_USRCHAR14 AS 'Hills Customer Channel',
    AC2.CU_USRCHAR15 AS 'Hills Customer Class',
    AC2.CU_USRNUM3 AS 'Disc 0 = %, 1 = Net',
    AC2.CU_USRNUM4 AS 'EOY Set Off %',
    AC2.CU_USRCHAR16 AS 'Champion Category',
    AC2.CU_USRCHAR17 AS 'BI Weekly Statement',
    --LEFT OUT--
