...
SELECT
    ...
    AC.CUCONTACT + ' / ' + AC2.CU_CONTACT_TITLE + ' / ' + AC2.CU_CONTACT_FIRSTNAME + AC2.CU_CONTACT_SURNAME + ' / ' + AC2.CU_MOBILE_NUMBER + ' / ' + AC2.CU_CONTACT_JOB + ' / ' + AC2.CU_CONTACT_INITIALS AS 'Contact / Title / First name / Surname / Mobile Phone / Job Title / Initials',
