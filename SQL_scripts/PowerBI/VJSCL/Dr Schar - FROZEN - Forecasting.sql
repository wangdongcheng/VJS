    ...
    ELSE 
      CASE 
        WHEN FLOOR(((S3.STK_USRNUM5 * Z.[3M_AVG]*S.STK_EC_SUP_UNIT) - LOC.STK_PHYSICAL - STK_ORDER_IN) 
                    / S.STK_EC_SUP_UNIT) / STK_USRNUM1 < 0 
        THEN 0 
        ELSE 
          ROUND(
            FLOOR(
      ...
      CASE 
        ...
        ELSE 
          CASE 
            ...
            ELSE CAST(
              (
                cast(LOC.STK_PHYSICAL/s.stk_ec_sup_unit as int) + cast(STK_ORDER_IN/s.stk_ec_sup_unit as int) + 
                ROUND(
                  FLOOR(
                    ((S3.STK_USRNUM5 * Z.[3M_AVG] * S.STK_EC_SUP_UNIT) - LOC.STK_PHYSICAL - STK_ORDER_IN)
                    / S.STK_EC_SUP_UNIT
          ...
          CASE 
            ...
            ELSE CAST(
              ROUND(
                ...
                ) * S.STK_EC_SUP_UNIT / STK_USRNUM6, 2
              ) AS DECIMAL(18, 2)
            )
          END 
      END 
      ...
      CASE 
        ...
        ELSE 
          CASE 
            ...
            ELSE CAST(
              (
                cast(LOC.STK_PHYSICAL/s.stk_ec_sup_unit as int) + cast(STK_ORDER_IN/s.stk_ec_sup_unit as int)+                ROUND(
                  FLOOR(
                    ((S3.STK_USRNUM5 * Z.[3M_AVG] * S.STK_EC_SUP_UNIT) - LOC.STK_PHYSICAL - STK_ORDER_IN)
                    / S.STK_EC_SUP_UNIT
                  ) / STK_USRNUM1, 0
