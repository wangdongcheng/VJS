...
STKCODE, STKNAME, STKCODE+' | '+STKNAME AS STK_CN,
 ...
 LEFT JOIN (
	...
	where det_date between cast(getdate()-91 as date) and cast(getdate()-1 as date) and det_type in ('INV','CRN') AND DET_LEDGER = 'SL' AND DET_STKSORTKEY3 = '30 FISH4PETS' AND STK_USRFLAG3 = 0 AND STK_USRFLAG2 = 1
 ...
 LEFT JOIN (
	...
	from SL_PL_NL_DETAIL 
	INNER JOIN STK_STOCK3 S3 ON S3.STKCODE3=DET_STOCK_CODE
	where det_date between cast(getdate()-366 as date) and cast(getdate()-1 as date) and det_type in ('INV','CRN') AND DET_LEDGER = 'SL' AND DET_STKSORTKEY3 = '30 FISH4PETS' AND STK_USRFLAG3 = 0 AND STK_USRFLAG2 = 1
