...
DECLARE @CustomerName TABLE (CustomerName NVARCHAR(200));
...
SELECT 
	...
	STK_SORT_KEY1 AS StockCategory,
	STK_SORT_KEY2 AS StockType,
...
WHERE a2.CU_USRCHAR14 = 'VET' and s.STK_SORT_KEY = '30 HILLS PET' AND CUNAME IN (SELECT CustomerName FROM @CustomerName)
GROUP BY cuuser2, cusort, CU_USRCHAR15,cuname, stk_sort_key, STK_SORT_KEY1, STK_SORT_KEY2, wd.WorkedDaysRatio
ORDER BY StockBrand
