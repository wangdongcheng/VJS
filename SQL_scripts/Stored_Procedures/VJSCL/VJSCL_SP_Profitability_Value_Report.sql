...
(CASE WHEN STK_SORT_KEY = '30 BOUCHARD' OR STK_SORT_KEY = '30 BOUCHARD DELISTED' THEN '30 IBA'
    --   when STK_SORT_KEY1 in ('30 HIL PD CAT', '30 HIL PD DOG') then '30 HIL PD (CAT+DOG)'
	--   when STK_SORT_KEY1 in ('30 HIL SP CAT', '30 HIL SP DOG') then '30 HIL SP (CAT+DOG)'
	ELSE STK_SORT_KEY1
	END)  AS 'Sort Key',
...
---
and (stk_sort_key like '30 HIL%' or stk_sort_key like '30 NIV%')
and stk_sort_key1 not in ('30 .NIV ADVERTISING',
'30 .NIV ATRIXO IGO',
'30 HIL PROMO MAT',
'30 HIL SAMPLES')
---
